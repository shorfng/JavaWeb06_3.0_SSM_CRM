...
<%@ taglib prefix="loto" uri="http://loto.cn/common/" %>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="customer.action" class="active">
                            <i class="fa fa-edit fa-fw"></i> 客户管理</a>
                    </li>

                    <li>
                        <a href="salevisit.action">
                            <i class="fa fa-dashboard fa-fw"></i> 客户拜访</a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <loto:page url="${pageContext.request.contextPath }/customer/list.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
